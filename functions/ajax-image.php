<?php
//Save image via AJAX
add_action('wp_ajax_s_ajax_upload', 's_ajax_image_upload'); //Add support for AJAX save

function s_ajax_image_upload(){
...
add_action('wp_ajax_s_ajax_remove', 's_ajax_image_remove'); //Add support for AJAX save

function s_ajax_image_remove(){
	global $wpdb; //Now WP database can be accessed
