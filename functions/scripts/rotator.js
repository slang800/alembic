jQuery(document).ready(function(){
			 ...
			 var newitem='<tr>';
				...
				newitem+=		'<input type="text" name="rockable_slider[image][]" />';
				newitem+=		'<div class="clearfix"></div>';

				newitem+=		'<label>Link:</label>';
				newitem+=		'<input type="text" name="rockable_slider[link][]" />';
				newitem+=		'<div class="clearfix"></div>';

				newitem+=		'<label>Title:</label>';
				newitem+=		'<input type="text" name="rockable_slider[title][]" />';
				newitem+=		'<div class="clearfix"></div>';

				newitem+=	'</td>';

				newitem+=	'<td>';
				newitem+=		'<textarea name="rockable_slider[desc][]" /></textarea>';
				newitem+=	'</td>';
